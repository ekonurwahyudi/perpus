...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'petugas';?>">Sistem Perpustakaan</a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url().'petugas/ganti_password';?>"><i class="fa fa-lock"></i> Ganti Password</a>
                        </li>
                    </ul>
                    ...
                    <a href="<?php echo base_url().'petugas/logout' ?>" class="btn btn-danger ml-1"><i class="fa fa-power-off"></i> KELUAR</a>
                </div>
        </div>
    </nav>
